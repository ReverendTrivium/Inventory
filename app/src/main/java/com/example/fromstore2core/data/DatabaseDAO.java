...
public class DatabaseDAO extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try {
            ...
            db.execSQL("CREATE TABLE GROCERYLISTITEMS(_id INTEGER PRIMARY KEY AUTOINCREMENT, IDGROCERYLIST INTEGER, DESCRIPTION TEXT, NOTE TEXT, CHECKED VARCHAR(1));");
            db.execSQL("INSERT INTO GROCERYLISTITEMS(_id,IDSHOPPINGLIST,DESCRIPTION,NOTE,CHECKED) SELECT ID, IDGROCERYLIST, DESCRIPTION, NOTE, CHECKED FROM GROCERYLISTITEMS;");
            ...
            db.execSQL("INSERT INTO GROCERYLISTITEMS(_id,IDSHOPPINGLIST,DESCRIPTION,NOTE,CHECKED) SELECT _id, IDSHOPPINGLIST, DESCRIPTION, NOTE, CHECKED FROM GROCERYLISTITEMSX;");
